...
class CourseRetrievalEngine() {
    ...
    def get_df(self, file_path: str = 'courses.json'):
        ...
        def get_description_sentiment(self, description: str) -> Tuple(str, str):
            """
        ...
        def clean_description(self, description: str) -> str:
            ...
            """
            description = self.make_lower_case(description)s
        ...
        @staticmethod
        def get_similarity_scores(description_array: List, embeddings) -> List(List):
            """
        ...
        def query_similar_courses(self, description: str, n: int):
            ...
            similar_courses = self.get_ensemble_similarity_scores(love_description)
            dissimilar_courses = self.get_dissimilarity_scores(hate_description)
            dissimilar_courses = dissimilar_courses.query('dissimilarity > .3')
            similar_courses= similar_perfumes.drop(dissimilar_courses.index)
